...
#ifndef __INET_BROADCASTWAITINGTABL2_H_
#define __INET_BROADCASTWAITINGTABL2_H_
...
class INET_API PacketWaitingTableforRBVTP {
    ...
    public:
         ...
         RBVTPPacket *  getRBVTPPacket(cMessage * timer );

         void  addPacket(cMessage * timer ,RBVTPPacket * packet,IPv4Datagram * ipv4);

         void  removePacket(cMessage* timer) ;

         cMessage* findPacket(RBVTPPacket*  packet) ;
