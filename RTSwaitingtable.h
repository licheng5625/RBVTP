...
#ifndef __INET_RTSWAITINGTABLE2_H_
#define __INET_RTSWAITINGTABLE2_H_
...
class INET_API RTSWaitingTableforRBVTP {
    ...
    public:
         ...
         bool getRBVTPPacket(RBVTPPacket* rtspacket)  ;
        bool hasWaitingRTS( RBVTPPacket* rtspacket);

        void addRTS(RBVTPPacket* rtspacket,RBVTPPacket* rbvtppacket);
